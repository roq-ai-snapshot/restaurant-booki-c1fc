...
export function TableListPage(props: TableListPageProps) {
      ...
      convertQueryToPrismaUtil(
        {
          ...
          searchTermKeys: ['location_description.contains'],
          ...params.filters,
        },
        'table',
      ),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'seating_capacity', header: 'seating_capacity', accessorKey: 'seating_capacity' },
    { id: 'location_description', header: 'Location Description', accessorKey: 'location_description' },
